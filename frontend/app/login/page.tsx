    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 mb-8">Please enter your details to access your project dashboard.</p>
          ...
          <form className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link href="/forgot-password" className="text-sm font-bold text-red-600 hover:text-red-700">Forgot?</Link>
              </div>
              <input 
                type="password" 
                id="password"
          ...
          <button className="w-full py-3 border-2 border-slate-100 hover:border-slate-300 hover:bg-slate-50 rounded-xl flex items-center justify-center gap-3 font-semibold text-slate-700 transition-all">
          ...
          <p className="mt-10 text-center text-slate-600">
            ...
            <Link href="/signup" className="font-bold text-red-600 hover:text-red-700">
              Start a project
            </Link>
          </p>
        </div>
